...
namespace Nevron.Examples.Diagram.Webform
{
	...
	/// </summary>
	public partial class NElectricalSymbolsShapesUC : NDiagramExampleUC
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			InitDocument(NDrawingView1.Document, new NElectricalSymbolsShapesFactory(NDrawingView1.Document));
