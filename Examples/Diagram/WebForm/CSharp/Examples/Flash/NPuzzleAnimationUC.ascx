<%@ Control Language="c#" Inherits="Nevron.Examples.Diagram.Webform.NPuzzleAnimationUC" CodeFile="NPuzzleAnimationUC.ascx.cs" %>
...
<tr>
	<td id="exampleImageCell" class="ImageCell">
        ...
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="600" height="600">
            ...
            <embed src="../Examples/Flash/NPuzzleAnimationRenderPage.aspx" width="600" height="600" />
        </object>
	</td>
