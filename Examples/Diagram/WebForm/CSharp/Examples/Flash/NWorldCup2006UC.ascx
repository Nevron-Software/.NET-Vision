<%@ Control Language="c#" Inherits="Nevron.Examples.Diagram.Webform.NWorldCup2006UC" CodeFile="NWorldCup2006UC.ascx.cs" %>
...
<tr>
	<td id="exampleImageCell" class="ImageCell">
        ...
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="600" height="600">
            ...
            <embed src="../Examples/Flash/NWorldCup2006RenderPage.aspx" width="640" height="600" />
        </object>
	</td>
