...
//				stateShape.Labels.AddChild(label);
				...
				string stateScript = "onmouseover = 'HighlightState(evt, \"" + ColorToSVG(stateHighlighColor) + "\")' onmouseout = 'HighlightState(evt, \"" + ColorToSVG(stateColor) + "\")'";
		...
		protected string GetScript()
		{
			...
			sScript.Append("function HighlightState(evt, color)\r\n");
			sScript.Append("{\r\n");
			sScript.Append("\r\n");
