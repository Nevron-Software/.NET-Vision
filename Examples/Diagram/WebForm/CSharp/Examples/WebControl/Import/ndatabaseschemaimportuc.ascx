<%@ Control Language="c#" Inherits="Nevron.Examples.Diagram.Webform.NDatabaseSchemaImportUC" CodeFile="ndatabaseschemaimportuc.ascx.cs" %>
<%@ Register TagPrefix="cc1" Namespace="Nevron.Diagram.WebForm" Assembly="Nevron.Diagram.WebForm" %>

<table style="width:700px;">
    <tr>
        <td>
            <div id="scrollDiv"  style="overflow: auto; width: 700px; height: 480px;">
