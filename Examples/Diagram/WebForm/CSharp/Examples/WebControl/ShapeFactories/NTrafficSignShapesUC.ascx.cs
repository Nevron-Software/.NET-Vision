...
{
	/// <summary>
	///	Summary description for NTrafficSignShapesUC.
	/// </summary>
	public partial class NTrafficSignShapesUC : NDiagramExampleUC
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			InitDocument(NDrawingView1.Document, new NTrafficSignsShapesFactory(NDrawingView1.Document));
