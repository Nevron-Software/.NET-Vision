...
namespace Nevron.Examples.Diagram.Webform
{
	...
	/// </summary>
	public partial class NBusinessProcessShapesUC : NDiagramExampleUC
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			InitDocument(NDrawingView1.Document, new NBusinessProcessShapesFactory(NDrawingView1.Document));
