...
Namespace Nevron.Examples.Diagram.Webform
	...
	Public Partial Class NWorldCup2006RenderPage
		...
		Private Sub SetAnimationsStyle(ByVal shape As NShape, ByVal depth As Integer)
			...
			If depth > 0 Then
				Dim fade As NFadeAnimation = New NFadeAnimation(0, depth * AnimationDuration)
				fade.EndAlpha = 0
				shape.Style.AnimationsStyle.Animations.Add(fade)
			End If

			shape.Style.AnimationsStyle.Animations.Add(New NFadeAnimation(depth * AnimationDuration, AnimationDuration))
		End Sub
		...
		Private Const AnimationDuration As Single = 1.0f
		Private Shared ReadOnly FlagSize As NSize = New NSize(48, 32)
			' Round of 16
			' Quarter finals
			' Semi finals
			' Final
