...
Namespace Nevron.Examples.Diagram.Webform
	...
	Public Partial Class NOrthogonalGraphLayoutUC
		...
		End Sub
		Private Sub CreateTestDiagram(ByVal document As NDrawingDocument)
		...
		Private Class DiagramRenderer
			Public Sub CreateGraph(ByVal document As NDrawingDocument, ByVal vertexCount As Integer, ByVal edgeCount As Integer)
				' Clear the document
