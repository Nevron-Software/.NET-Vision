...
Namespace Nevron.Examples.Diagram.Webform
	...
	Public Partial Class NRadialGraphLayoutUC
		...
		Private Sub InitDocument(ByVal document As NDrawingDocument)
			...
			sheet.Style.StartArrowheadStyle = New NArrowheadStyle(ArrowheadShape.None, String.Empty, NSizeL.Empty, document.Style.FillStyle, document.Style.StrokeStyle)
			sheet.Style.EndArrowheadStyle = New NArrowheadStyle(ArrowheadShape.None, String.Empty, NSizeL.Empty, document.Style.FillStyle, document.Style.StrokeStyle)
