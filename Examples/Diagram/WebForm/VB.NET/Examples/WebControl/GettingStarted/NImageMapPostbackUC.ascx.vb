...
Namespace Nevron.Examples.Diagram.Webform.GettingStarted
	''' <summary>
	'''		Summary description for NImageMapPostback.
	''' </summary>
	Public Partial Class NImageMapPostback
		...
		Protected Function CreateOrgChartShape(ByVal info As NPersonalInfo) As NCompositeShape
			...
			interactivityStyle.Tooltip.Text = "Click to select " & info.Name
			interactivityStyle.GeneratePostback = True
			shape.Style.InteractivityStyle = interactivityStyle

			AddHandler Document.EventSinkService.NodeClick, AddressOf OnNodeClicked
		...
		Public Sub OnNodeClicked(ByVal args As NNodeViewEventArgs)
