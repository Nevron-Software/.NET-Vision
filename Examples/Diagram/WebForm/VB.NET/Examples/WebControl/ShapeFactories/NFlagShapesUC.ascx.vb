...
Namespace Nevron.Examples.Diagram.Webform
	''' <summary>
	'''	Summary description for NFlagShapesUC.
	''' </summary>
	Public Partial Class NFlagShapesUC
		...
		Protected Sub InitDocument(ByVal document As NDrawingDocument, ByVal factory As NShapesFactory)
			...
			NDrawingView1.Document.BackgroundStyle.FillStyle = New NColorFillStyle(Color.FromArgb(&Hca, &Hca, &Hca))
