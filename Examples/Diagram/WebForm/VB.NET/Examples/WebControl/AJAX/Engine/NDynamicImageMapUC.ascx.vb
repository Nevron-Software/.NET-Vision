...
Namespace Nevron.Examples.Diagram.Webform
	...
	Public Partial Class NDynamicImageMapUC
		...
		Protected Sub NDrawingView1_AsyncMouseOver(ByVal sender As Object, ByVal e As EventArgs)
		...
		Protected Sub NDrawingView1_AsyncMouseOut(ByVal sender As Object, ByVal e As EventArgs)
			Dim args As NCallbackMouseEventArgs = TryCast(e, NCallbackMouseEventArgs)
			If args.ItemId Is Nothing Then
				Return
			End If
