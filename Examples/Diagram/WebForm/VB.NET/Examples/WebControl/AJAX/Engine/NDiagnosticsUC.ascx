<%@ Control Language="vb" Inherits="Nevron.Examples.Diagram.Webform.NDiagnosticsUC" CodeFile="NDiagnosticsUC.ascx.vb" %>
...
<tr>
	<td id="exampleImageCell" class="ImageCell" style="width: 442px; vertical-align: middle;">
		...
		<ncwd:NDrawingView id="NDrawingView1" runat="server" Width="416px" Height="320px" AjaxEnabled="True" AsyncAutoRefreshEnabled="True" AsyncRefreshInterval="1000" AsyncRequestWaitCursorEnabled="False" AsyncRefreshEnabled="True" OnQueryAjaxTools="NDrawingView1_QueryAjaxTools" AjaxScriptBuild="Debug">
		</ncwd:NDrawingView>
...
var cs =
NDiagramCallbackService.GetCallbackService(
"ctl04_NDrawingView1");
...
if(NReflection.IsOfType(
cs, "NDiagramCallbackService"))
NDiagnostics.Trace("NDiagramCallbackService");  
</span>
