...
Namespace Nevron.Examples.Diagram.WinForm
	...
	''' </summary>
	Public Class NArrowheadShapesStencilUC
		...
		Private Sub InitializeComponent()
			...
			' 
			Me.Name = "NArrowheadShapesStencilUC"
		...
		Private Sub InitDocument()
			...
			For Each arrowheadShape As NArrowheadShape In document.ArrowheadShapeStencil.PredefinedArrowheadShapes
				' create the path representing the arrow head shape
				Dim path As NCustomPath
				If arrowheadShape.Closed Then
					path = New NCustomPath(CType(arrowheadShape.Path.Clone(), GraphicsPath),PathType.ClosedFigure)
				Else
					path = New NCustomPath(CType(arrowheadShape.Path.Clone(), GraphicsPath),PathType.OpenFigure)
				End If
				...
				' describe it
				Dim str As String = NExamplesHelper.InsertSpacesBeforeUppers((CType(index + 2, ArrowheadShape)).ToString())
