...
'			Me.ShowDesiredSizeCheckBox.CheckedChanged += New System.EventHandler(Me.ShowDesiredSizeCheckBox_CheckedChanged);
		...
		Protected Overrides Sub LoadExample()
			...
			' init document
			document.BeginInit()
			document.Style.FillStyle = New NGradientFillStyle(GradientStyle.Horizontal, GradientVariant.Variant4, Color.FromArgb(129, 133, 133), Color.FromArgb(192, 194, 194))
		...
		Private m_Layout As NFlowLayout
