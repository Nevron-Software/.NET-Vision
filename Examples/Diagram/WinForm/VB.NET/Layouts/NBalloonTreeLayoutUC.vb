...
Namespace Nevron.Examples.Diagram.WinForm
	...
	''' </summary>
	Public Class NBalloonTreeLayoutUC
...
'			Me.LayoutButton.Click += New System.EventHandler(Me.LayoutButton_Click);
		...
		Private Sub LayoutButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles LayoutButton.Click
			...
			Dim containerAdapter As NDrawingBodyContainerAdapter = New NDrawingBodyContainerAdapter(document)
		...
		Private m_Layout As NBalloonTreeLayout
