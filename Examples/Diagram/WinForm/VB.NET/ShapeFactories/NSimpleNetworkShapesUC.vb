...
Namespace Nevron.Examples.Diagram.WinForm
	...
	''' </summary>
	Public Class NSimpleNetworkShapesUC
		...
		Private Sub InitializeComponent()
			' 
			' NSimpleNetworkShapesUC
			' 
			Me.Name = "NSimpleNetworkShapesUC"
		...
		Private Sub InitDocument()
			...
			Dim factory As NSimpleNetworkShapesFactory = New NSimpleNetworkShapesFactory(document)
