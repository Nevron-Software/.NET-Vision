...
Namespace Nevron.Examples.Diagram.WinForm
	...
	''' </summary>
	Public Class NElectricalSymbolsShapesUC
		...
		Private Sub InitializeComponent()
			...
			' 
			Me.Name = "NElectricalSymbolsShapesUC"
		...
		Private Sub InitDocument()
			...
			Dim factory As NElectricalSymbolsShapesFactory = New NElectricalSymbolsShapesFactory(document)
