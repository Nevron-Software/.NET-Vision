...
#Region "Implementation"
		...
		Private Sub ImportData()
			...
			Dim databasePath As String = Path.Combine(Application.StartupPath, "..\..\Resources\Data\Data.xlsx")
...
#Region "Event Handlers"
		...
		Private Sub OnEdgeImported(ByVal dataSourceImporter As NDataSourceImporter, ByVal shape As NShape, ByVal dataRecord As INDataRecord)
			...
			Dim protection As NAbilities = customShape.Protection
			protection.All = True
...
#Region "Nested Types"
		...
		Private Class GroupShapesFactory
			...
			Public Overloads Overrides Function CreateShape(ByVal index As Integer) As NShape
