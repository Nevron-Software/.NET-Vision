...
{
	/// <summary>
    /// Summary description for NTableShapeEventsUC.
	/// </summary>
	public class NTableShapeEventsUC : NDiagramExampleUC
	{
		#region Constructors

        public NTableShapeEventsUC(NMainForm form)
            : base(form)
		{
			InitializeComponent();
		}
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(NTableShapeEventsUC));
