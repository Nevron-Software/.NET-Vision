...
namespace Nevron.Examples.Diagram.WinForm
{
	...
	/// </summary>
	public class NExcelImportUC : NDiagramExampleUC
	{
		#region Constructor

		public NExcelImportUC(NMainForm form)
			: base(form)
		{
		}
		...
		private void ImportData()
		{
			...
			string databasePath = Path.Combine(Application.StartupPath, @"..\..\Resources\Data\Data.xlsx");
