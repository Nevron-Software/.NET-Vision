...
namespace Nevron.Examples.Diagram.WinForm
{
    ...
    /// </summary>
    public class NFlowLayoutUC : NDiagramExampleUC
    {
        #region Constructor

        public NFlowLayoutUC(NMainForm form)
            : base(form)
        {
            InitializeComponent();
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.ShowDesiredSizeCheckBox.TabIndex = 8;
