...
namespace Nevron.Examples.Diagram.WinForm
{
    ...
    /// </summary>
    public class NTableLayoutUC : NDiagramExampleUC
    {
        #region Constructor

        public NTableLayoutUC(NMainForm form)
            : base(form)
        {
            InitializeComponent();
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.ShowDesiredSizeCheckBox.TabIndex = 9;
