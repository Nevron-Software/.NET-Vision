...
namespace Nevron.Examples.Diagram.WinForm
{
    ...
    /// </summary>
    public class NBalloonTreeLayoutUC : NDiagramExampleUC
    {
        #region Constructor

        public NBalloonTreeLayoutUC(NMainForm form)
            : base(form)
		{
			InitializeComponent();
		}
        ...
        {
            // init form fields
            m_Layout = new NBalloonTreeLayout();
            m_Layout.StartAngle = 45;
        ...
        private void LayoutButton_Click(object sender, EventArgs e)
        {
            ...
            NDrawingBodyContainerAdapter containerAdapter = new NDrawingBodyContainerAdapter(document);
            containerAdapter.SetLayoutArea(new NRectangleF(0, 0, 700, 700));
        ...
        private NBalloonTreeLayout m_Layout;
