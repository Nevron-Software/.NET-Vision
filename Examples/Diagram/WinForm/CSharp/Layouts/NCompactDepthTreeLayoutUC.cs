...
namespace Nevron.Examples.Diagram.WinForm
{
    ...
    /// </summary>
    public class NCompactDepthTreeLayoutUC : NDiagramExampleUC
    {
        #region Constructor

        public NCompactDepthTreeLayoutUC(NMainForm form)
            : base(form)
		{
			InitializeComponent();
		}
        ...
        private NCompactDepthTreeLayout m_Layout;
