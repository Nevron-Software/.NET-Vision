...
{
	/// <summary>
	/// Summary description for NBusinessProcessShapesUC.
	/// </summary>
	public class NBusinessProcessShapesUC : NDiagramExampleUC
	{
		#region Constructor

		public NBusinessProcessShapesUC(NMainForm form)
			: base(form)
		{
			InitializeComponent();
		}
		...
		private void InitDocument()
		{
			...
			NBusinessProcessShapesFactory factory = new NBusinessProcessShapesFactory(document);
