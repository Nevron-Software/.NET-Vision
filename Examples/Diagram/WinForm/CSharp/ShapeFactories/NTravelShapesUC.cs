...
{
	/// <summary>
	/// Summary description for NTravelShapesUC.
	/// </summary>
	public class NTravelShapesUC : NDiagramExampleUC
	{
		#region Constructor

		public NTravelShapesUC(NMainForm form) : base(form)
		{
			InitializeComponent();
		}
		...
		private void InitDocument()
		{
			...
			NTravelShapesFactory factory = new NTravelShapesFactory(document);
