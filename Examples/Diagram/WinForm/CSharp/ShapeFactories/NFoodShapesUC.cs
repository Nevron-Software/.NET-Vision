...
{
	/// <summary>
	/// Summary description for NFoodShapesUC.
	/// </summary>
	public class NFoodShapesUC : NDiagramExampleUC
	{
		#region Constructor

		public NFoodShapesUC(NMainForm form) : base(form)
		{
			InitializeComponent();
		}
		...
		private void InitDocument()
		{
			...
			NFoodShapesFactory factory = new NFoodShapesFactory(document);
