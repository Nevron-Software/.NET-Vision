...
namespace Nevron.Examples.Diagram.WinForm
{
	...
	/// </summary>
	public class NBrainstormingShapesUC : NDiagramExampleUC
	{
		#region Constructor

		public NBrainstormingShapesUC(NMainForm form) : base(form)
		{
			InitializeComponent();
		}
		...
		{
			// 
			// NBrainstormingShapesUC
			// 
			this.Name = "NBrainstormingShapesUC";
