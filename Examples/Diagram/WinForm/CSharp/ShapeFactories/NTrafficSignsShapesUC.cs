...
{
	/// <summary>
	/// Summary description for NTrafficSignsShapesUC.
	/// </summary>
	public class NTrafficSignsShapesUC : NDiagramExampleUC
	{
		#region Constructor

		public NTrafficSignsShapesUC(NMainForm form) : base(form)
		{
			InitializeComponent();
		}
		...
		{
			// 
			// NTrafficSignsShapesUC
			// 
			this.Name = "NTrafficSignsShapesUC";
		...
		private void InitDocument()
		{
			...
			NTrafficSignsShapesFactory factory = new NTrafficSignsShapesFactory(document);
