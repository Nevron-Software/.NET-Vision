...
namespace Nevron.Examples.Diagram.WinForm
{
	...
	/// </summary>
	public class NSymbolShapesUC : NDiagramExampleUC
	{
		#region Constructor

		public NSymbolShapesUC(NMainForm form) : base(form)
		{
			InitializeComponent();
		}
		...
		private void InitDocument()
		{
			...
			NSymbolShapesFactory factory = new NSymbolShapesFactory(document);
			factory.DefaultSize = new NSizeF(80, 60);
			
			int count = factory.ShapesCount;
			for (int i = 0; i < count; i++)
			{
				// create a symbol shape
