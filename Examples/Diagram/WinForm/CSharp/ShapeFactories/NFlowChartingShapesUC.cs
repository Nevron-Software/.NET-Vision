...
{
	/// <summary>
	/// Summary description for NFlowChartingShapesUC.
	/// </summary>
	public class NFlowChartingShapesUC : NDiagramExampleUC
	{
		#region Constructor

		public NFlowChartingShapesUC(NMainForm form) : base(form)
		{
			InitializeComponent();
		}
		...
		{
			// 
			// NFlowChartingShapesUC
			// 
			this.Name = "NFlowChartingShapesUC";
