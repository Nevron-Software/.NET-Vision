...
public partial class _Default : System.Web.UI.Page
{
	protected override void Render(HtmlTextWriter writer)
	{
		...
		// Root frame begin
		writer.WriteLine("<frameset cols='*,1050,*' framespacing='0' frameBorder = '0' >");
		writer.WriteLine("<frame name='left' border='0'>");
		// Root frame begin

		writer.WriteLine("<frameset rows='87px, *, 20px' framespacing='0' frameBorder = '0' >");
		writer.WriteLine("	<frame src='Frames/TopBanner.aspx' name='BannerFrame' noresize='noresize' frameborder='0' scrolling='no' marginwidth='0' marginheight='0' style='border-left-width:0px; border-top-width:0px;' />");
		writer.WriteLine("	<frameset cols='304, *' framespacing='0' border='0'>");
		writer.WriteLine("		<frame src='Frames/NNavigationFrame.aspx' name='NavigationFrame' noresize='noresize' frameborder='0' scrolling='no' marginwidth='0' marginheight='0' style='border-left-width:0px; border-top-width:0px;' />");
		writer.WriteLine("		<frame src='Examples/Index' name='ExampleViewFrame' noresize='noresize' frameborder='0' scrolling='no' marginwidth='0' marginheight='0' style='border-left-width:0px; border-top-width:0px;' />");
		writer.WriteLine("	</frameset>");
		writer.WriteLine("	<frame src='Frames/Footer.aspx' name='FooterFrame' noresize='noresize' frameborder='0' scrolling='no' marginwidth='0' marginheight='0' style='border-left-width:0px; border-top-width:0px;' />");
		writer.WriteLine("</frameset>");
