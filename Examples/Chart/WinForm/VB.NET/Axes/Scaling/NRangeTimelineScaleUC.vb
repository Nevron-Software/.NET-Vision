...
Namespace Nevron.Examples.Chart.WinForm
	<ToolboxItem(False)> _
	Public Class NRangeTimelineScaleUC
		...
		Private WithEvents CreateSeparatorForEachRowCheckBox As Nevron.UI.WinForm.Controls.NCheckBox
		...
		Private Sub InitializeComponent()
			...
			Me.CreateSeparatorForEachRowCheckBox = New Nevron.UI.WinForm.Controls.NCheckBox()
...
'ORIGINAL LINE: this.DailyDataButton.Click += new System.EventHandler(this.DailyDataButton_Click);
			...
			' 
			Me.CreateSeparatorForEachRowCheckBox.AutoSize = True
			Me.CreateSeparatorForEachRowCheckBox.ButtonProperties.BorderOffset = 2
			Me.CreateSeparatorForEachRowCheckBox.Location = New System.Drawing.Point(12, 11)
			Me.CreateSeparatorForEachRowCheckBox.Name = "CreateSeparatorForEachRowCheckBox"
			Me.CreateSeparatorForEachRowCheckBox.Size = New System.Drawing.Size(149, 17)
			Me.CreateSeparatorForEachRowCheckBox.TabIndex = 13
			Me.CreateSeparatorForEachRowCheckBox.Text = "Create Separator per Row"
			Me.CreateSeparatorForEachRowCheckBox.UseVisualStyleBackColor = True
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.CreateSeparatorForEachRowCheckBox.CheckedChanged += new System.EventHandler(this.CreateSeparatorForEachRowCheckBox_CheckedChanged);
			' 
...
'ORIGINAL LINE: this.FirstRowVisibleCheckBox.CheckedChanged += new System.EventHandler(this.FirstRowVisibleCheckBox_CheckedChanged);
			...
			Me.Controls.Add(Me.CreateSeparatorForEachRowCheckBox)
			...
			Me.Name = "NRangeTimelineScaleUC"
			Me.Size = New System.Drawing.Size(183, 259)
		...
		Public Overrides Sub Initialize()
			...
			' set a chart title
			Dim header As New NLabel("Range Timeline Scale<br/><font size = '9pt'>Demonstrates how to use a timeline scale to show date/time information on the X axis</font>")
		...
		Private Sub UpdateScale()
			Dim timelineScale As NRangeTimelineScaleConfigurator = TryCast(m_Chart.Axis(StandardAxis.PrimaryX).ScaleConfigurator, NRangeTimelineScaleConfigurator)
		...
		Private Sub CreateSeparatorForEachRowCheckBox_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles CreateSeparatorForEachRowCheckBox.CheckedChanged
			UpdateScale()
		End Sub
	End Class
End Namespace
