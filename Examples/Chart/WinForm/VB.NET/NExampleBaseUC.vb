...
#End Region
        ...
        End Sub
        Friend Sub FillStockDates(ByVal stock As NStockSeries, ByVal count As Integer, ByVal startDate As DateTime)
            stock.XValues.Clear()
        ...
        Friend Shared weekDays As String() = New String() {"Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"}
