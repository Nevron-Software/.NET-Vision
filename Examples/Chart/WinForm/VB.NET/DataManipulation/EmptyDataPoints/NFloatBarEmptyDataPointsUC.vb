...
Namespace Nevron.Examples.Chart.WinForm
	<ToolboxItem(False)> _
	Public Class NFloatBarEmptyDataPointsUC
		...
		Private Sub InitializeComponent()
			Dim resources As New System.Resources.ResourceManager(GetType(NFloatBarEmptyDataPointsUC))
...
'ORIGINAL LINE: this.ShowLabelsCheck.CheckedChanged += new System.EventHandler(this.ShowLabelsCheck_CheckedChanged);
			...
			Me.SeriesTypeCombo.TabIndex = 23
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
...
'ORIGINAL LINE: this.EDPMarkerButton.Click += new System.EventHandler(this.EDPMarkerButton_Click);
			...
			Me.Name = "NFloatBarEmptyDataPointsUC"
		...
		Private Sub GenerateData(ByVal ds1 As NDataSeriesDouble, ByVal ds2 As NDataSeriesDouble, ByVal nTotalCount As Integer, ByVal nMaxEmptyCount As Integer)
		...
		Private Sub SeriesTypeCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles SeriesTypeCombo.SelectedIndexChanged
			...
			Select Case SeriesTypeCombo.SelectedIndex
				Case 0
					series = CType(chart.Series.Add(SeriesType.FloatBar), NSeries)
					Dim bar As NFloatBarSeries = CType(series, NFloatBarSeries)
					GenerateData(bar.Values, bar.EndValues, 10, 3)

				Case 1
					series = CType(chart.Series.Add(SeriesType.HighLow), NSeries)
					Dim highLow As NHighLowSeries = CType(series, NHighLowSeries)
