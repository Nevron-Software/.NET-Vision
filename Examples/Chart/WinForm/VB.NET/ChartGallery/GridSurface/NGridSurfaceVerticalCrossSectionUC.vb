...
Namespace Nevron.Examples.Chart.WinForm
	...
	Public Class NGridSurfaceVerticalCrossSectionUC
		...
		Private WithEvents LockZCheckBox As UI.WinForm.Controls.NCheckBox
		Private WithEvents LockXCheckBox As UI.WinForm.Controls.NCheckBox
		...
		Private Sub InitializeComponent()
			...
			Me.LockZCheckBox = New Nevron.UI.WinForm.Controls.NCheckBox()
			Me.LockXCheckBox = New Nevron.UI.WinForm.Controls.NCheckBox()
			Me.SuspendLayout()
			' 
			' label1
			' 
...
'ORIGINAL LINE: this.DragPlaneComboBox.SelectedIndexChanged += new System.EventHandler(this.DragPlaneComboBox_SelectedIndexChanged);
			...
			' LockZCheckBox
			' 
			Me.LockZCheckBox.ButtonProperties.BorderOffset = 2
			Me.LockZCheckBox.Location = New System.Drawing.Point(11, 74)
			Me.LockZCheckBox.Name = "LockZCheckBox"
			Me.LockZCheckBox.Size = New System.Drawing.Size(157, 21)
			Me.LockZCheckBox.TabIndex = 9
			Me.LockZCheckBox.Text = "Lock Y"
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.LockZCheckBox.CheckedChanged += new System.EventHandler(this.LockZCheckBox_CheckedChanged);
			' 
			' LockXCheckBox
			' 
			Me.LockXCheckBox.ButtonProperties.BorderOffset = 2
			Me.LockXCheckBox.Enabled = False
			Me.LockXCheckBox.Location = New System.Drawing.Point(11, 54)
			Me.LockXCheckBox.Name = "LockXCheckBox"
			Me.LockXCheckBox.Size = New System.Drawing.Size(157, 20)
			Me.LockXCheckBox.TabIndex = 8
			Me.LockXCheckBox.Text = "Lock X"
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.LockXCheckBox.CheckedChanged += new System.EventHandler(this.LockXCheckBox_CheckedChanged);
			' 
			' NGridSurfaceVerticalCrossSectionUC
			' 
			Me.Controls.Add(Me.LockZCheckBox)
			Me.Controls.Add(Me.LockXCheckBox)
		...
		Private Sub LockXCheckBox_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles LockXCheckBox.CheckedChanged
			m_DragPlane.LockX = LockXCheckBox.Checked
		End Sub

		Private Sub LockZCheckBox_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles LockZCheckBox.CheckedChanged
			m_DragPlane.LockZ = LockZCheckBox.Checked
		End Sub
	End Class
...
#Region "Overrides"
        ...
        Public Overrides Function CanBeginDrag(ByVal sender As Object, ByVal e As Nevron.Chart.Windows.NMouseEventArgs) As Boolean
            ...
            Dim point As New NPoint(e.X, e.Y)
        ...
        Public Overrides Sub OnDoDrag(ByVal sender As Object, ByVal e As Nevron.Chart.Windows.NMouseEventArgs)
            ...
            Select Case m_DragPlaneSurface
                Case DragPlaneSurface.XY
                    viewToScale = New NViewToScale3DTransformation(Me.GetView().Context, chart, CInt(StandardAxis.PrimaryX), CInt(StandardAxis.PrimaryY), CInt(StandardAxis.Depth), m_OriginalPosition.Z)
                Case DragPlaneSurface.XZ
                    viewToScale = New NViewToScale3DTransformation(Me.GetView().Context, chart, CInt(StandardAxis.PrimaryX), CInt(StandardAxis.Depth), CInt(StandardAxis.PrimaryY), m_OriginalPosition.Y)
                Case DragPlaneSurface.ZY
                    viewToScale = New NViewToScale3DTransformation(Me.GetView().Context, chart, CInt(StandardAxis.Depth), CInt(StandardAxis.PrimaryY), CInt(StandardAxis.PrimaryX), m_OriginalPosition.X)
                Case Else
...
'INSTANT VB NOTE: The variable pointSeries was renamed since Visual Basic does not handle local variables named the same as class members well:
			...
			pointSeries_Renamed.FillStyles(2) = New NColorFillStyle(Color.Red)


			pointSeries_Renamed.Values.Add(vecD.Y)
			pointSeries_Renamed.XValues.Add(vecD.X)
			pointSeries_Renamed.ZValues.Add(vecD.Z)
			pointSeries_Renamed.FillStyles(3) = New NColorFillStyle(Color.Blue)
...
'		[field: NonSerialized]
		...
		Private Sub SynchronizePoints(ByVal modifiedPointIndex As Integer)
