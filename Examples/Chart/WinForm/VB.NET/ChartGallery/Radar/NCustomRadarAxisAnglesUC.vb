...
Namespace Nevron.Examples.Chart.WinForm
	...
	Public Class NCustomRadarAxisAnglesUC
		...
		Private Sub InitializeComponent()
			Me.SuspendLayout()
			' 
			' NCustomRadarAxisAnglesUC
			' 
			Me.AutoScaleDimensions = New System.Drawing.SizeF(6F, 13F)
			Me.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font
			Me.Name = "NCustomRadarAxisAnglesUC"
		...
		Public Overrides Sub Initialize()
			...
			Dim angleStep As Single = 180.0F / (radarChart.Axes.Count - 1)

			For i As Integer = 0 To radarChart.Axes.Count - 1
				Dim radarAxis As NRadarAxis = DirectCast(radarChart.Axes(i), NRadarAxis)

				CType(radarAxis.Anchor, NRadarAxisAnchor).UseCustomAngle = True
				CType(radarAxis.Anchor, NRadarAxisAnchor).CustomAngle = i * angleStep
			Next i
