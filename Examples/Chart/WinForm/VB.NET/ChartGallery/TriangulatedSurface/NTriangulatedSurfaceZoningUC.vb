...
Namespace Nevron.Examples.Chart.WinForm
	<ToolboxItem(False)>
	Public Class NTriangulatedSurfaceZoningUC
...
'ORIGINAL LINE: this.paletteModeCombo.SelectedIndexChanged += new System.EventHandler(this.PaletteModeCombo_SelectedIndexChanged);
			...
			Me.Name = "NTriangulatedSurfaceZoningUC"
		...
		Public Overrides Sub Initialize()
			...
			' set a chart title
			Dim title As NLabel = nChartControl1.Labels.AddHeader("Triangulated Surface Zoning")
