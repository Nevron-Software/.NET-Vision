...
'ORIGINAL LINE: this.Add20KDataButton.Click += new System.EventHandler(this.Add20KDataButton_Click);
		...
		Private Sub AddNewData(ByVal count As Integer)
			...
			If valueCount > 0 Then
				prevXVal = DirectCast(m_Area.XValues(valueCount - 1), Double)
				prevYVal = DirectCast(m_Area.Values(valueCount - 1), Double)
			End If
			...
			Do While i < valueCount - 1
				Dim prevVal As Double = DirectCast(m_Area.XValues(i), Double)
				Dim nextVal As Double = DirectCast(m_Area.XValues(i + 1), Double)
