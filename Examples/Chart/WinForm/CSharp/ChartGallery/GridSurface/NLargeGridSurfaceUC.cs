...
{
	[ToolboxItem(false)]
	public class NLargeGridSurfaceUC : NExampleBaseUC
	{
		...
		private void SurfaceSizeCombo_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			switch (surfaceSizeCombo.SelectedIndex)
			{
				...
				case 2:
					heightMapName = "HeightMap2048.png";
					break;
