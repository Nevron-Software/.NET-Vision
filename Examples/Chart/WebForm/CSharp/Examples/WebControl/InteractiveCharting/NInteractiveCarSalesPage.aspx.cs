...
{
	public partial class NInteractiveCarSalesPage : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			// set a chart title
			NLabel header = nChartControl1.Labels.AddHeader("Car Sales");
			...
			chart.Location = new NPointL(new NLength(7, NRelativeUnit.ParentPercentage),
