...
{
	public partial class NDynamicCursorUC : NExampleUC
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
			if (nChartControl1.RequiresInitialization)
			{
                ...
                //	set up client side cursors
                pie.InteractivityStyles.Add(0, new NInteractivityStyle(true, null, null, CursorType.Hand));
                pie.InteractivityStyles.Add(1, new NInteractivityStyle(true, null, null, CursorType.Cross));
                pie.InteractivityStyles.Add(2, new NInteractivityStyle(true, null, null, CursorType.SizeAll));
                pie.InteractivityStyles.Add(3, new NInteractivityStyle(true, null, null, CursorType.VSplit));
