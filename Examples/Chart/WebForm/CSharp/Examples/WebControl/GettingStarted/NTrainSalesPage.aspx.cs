...
{
	public partial class NTrainSalesPage : Page
	{
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			NLabel title = new NLabel("Train Sales by Company");
			...
			// setup the watermark
			watermark.FillStyle = new NImageFillStyle(this.MapPathSecure("~\\Images\\train.png"));
