...
{
	public partial class NCarSalesPage : Page
	{
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			NLabel title = new NLabel("Car Sales by Company");
			...
			// setup the watermark
			watermark.FillStyle = new NImageFillStyle(this.MapPathSecure("~\\Images\\car.png"));
			...
			pie.Labels.Add("Toyota");
			pie.Labels.Add("Volkswagen");
