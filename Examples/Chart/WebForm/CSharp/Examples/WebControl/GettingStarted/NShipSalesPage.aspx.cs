...
{
	public partial class NShipSalesPage : Page
	{
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			NLabel title = new NLabel("Ship Sales by Company");
			...
			// setup the watermark
			watermark.FillStyle = new NImageFillStyle(this.MapPathSecure("~\\Images\\ship.png"));
