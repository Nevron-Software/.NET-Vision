...
{
	public partial class NAdvancedFunnel3DUC : NExampleUC
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			chart.Size = new NSizeL(
				...
				new NLength(63, NRelativeUnit.ParentPercentage));
			...
			if (!IsPostBack)
			{
				...
				FunnelArrowLengthDropDownList.SelectedIndex = (int)funnel.DataLabelStyle.ArrowLength.Value;
			}
