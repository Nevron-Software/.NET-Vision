...
Namespace Nevron.Examples.Chart.WebForm
	Public Partial Class NInteractiveCarSalesPage
		...
		Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
			...
			' set a chart title
			Dim header As NLabel = nChartControl1.Labels.AddHeader("Car Sales")
			...
			Else
				chart.Width = 86
				chart.Height = 73 * fAspect
			End If

			chart.Location = New NPointL(New NLength(7, NRelativeUnit.ParentPercentage), New NLength(15, NRelativeUnit.ParentPercentage))
			chart.Size = New NSizeL(New NLength(86, NRelativeUnit.ParentPercentage), New NLength(73, NRelativeUnit.ParentPercentage))
