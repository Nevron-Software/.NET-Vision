	...
	Public Partial Class NDynamicCursorUC
		...
		Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
			If nChartControl1.RequiresInitialization Then
				...
				pie.InteractivityStyles.Add(0, New NInteractivityStyle(True, Nothing, Nothing, CursorType.Hand))
				pie.InteractivityStyles.Add(1, New NInteractivityStyle(True, Nothing, Nothing, CursorType.Cross))
				pie.InteractivityStyles.Add(2, New NInteractivityStyle(True, Nothing, Nothing, CursorType.SizeAll))
				pie.InteractivityStyles.Add(3, New NInteractivityStyle(True, Nothing, Nothing, CursorType.VSplit))
