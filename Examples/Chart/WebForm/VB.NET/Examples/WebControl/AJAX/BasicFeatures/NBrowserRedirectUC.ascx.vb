	...
	Public Partial Class NBrowserRedirectUC
		...
		Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
			If nChartControl1.RequiresInitialization Then
				...
				pie.InteractivityStyles.Add(0, New NInteractivityStyle(True, Nothing, Nothing, CursorType.Default, "http://www.nevron.com/Products.Nevron.NETVision.Overview.aspx"))
				pie.InteractivityStyles.Add(1, New NInteractivityStyle(True, Nothing, Nothing, CursorType.Default, "http://www.nevron.com/Products.ChartFor.NET.Overview.aspx"))
				pie.InteractivityStyles.Add(2, New NInteractivityStyle(True, Nothing, Nothing, CursorType.Default, "http://www.nevron.com/Products.DiagramFor.NET.Overview.aspx"))
				pie.InteractivityStyles.Add(3, New NInteractivityStyle(True, Nothing, Nothing, CursorType.Default, "http://www.nevron.com/Products.UserInterfaceFor.NET.Overview.aspx"))
