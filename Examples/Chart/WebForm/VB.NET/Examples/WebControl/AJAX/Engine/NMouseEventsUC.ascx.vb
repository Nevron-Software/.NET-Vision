...
Namespace Nevron.Examples.Chart.WebForm
	Public Partial Class NMouseEventsUC
		...
		Protected Sub nChartControl1_AsyncDoubleClick(ByVal sender As Object, ByVal e As EventArgs)
			Dim palette As NChartPalette = New NChartPalette(ChartPredefinedPalette.Nevron)
			ProcessMouseEvent(sender, e, palette.GaugeBackgroundForeColor)
		End Sub

		Protected Sub nChartControl1_AsyncMouseDown(ByVal sender As Object, ByVal e As EventArgs)
			Dim palette As NChartPalette = New NChartPalette(ChartPredefinedPalette.Nevron)
			ProcessMouseEvent(sender, e, palette.GaugeBackgroundForeColor)
		End Sub
		...
		Protected Sub nChartControl1_AsyncMouseUp(ByVal sender As Object, ByVal e As EventArgs)
			Dim palette As NChartPalette = New NChartPalette(ChartPredefinedPalette.Nevron)
			ProcessMouseEvent(sender, e, palette.GaugeBackgroundForeColor)
		End Sub
		...
		Private Sub ProcessMouseEvent(ByVal sender As Object, ByVal e As EventArgs, ByVal c As Color)
			...
			If result.ChartElement = ChartElement.DataPoint Then
				Select Case result.Chart.Tag.ToString()
					Case "BarChart"
						...
						For Each series As NBarSeries In nChartControl1.Charts(0).Series
						...
						Dim nCount As Integer = nChartControl1.Panels.Count
						Dim i As Integer = 0
						Do While i < nCount
							If TypeOf nChartControl1.Panels(i) Is NRoundedRectangularCallout Then
