<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NDynamicImageMapUC" CodeFile="NDynamicImageMapUC.ascx.vb" %>
...
<tr>
	<td id="exampleDescriptionCell" class="Description">
		...
		for the separate elements of the chart.
		<br />&nbsp;<br />
