<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NInstantMouseEventsUC" CodeFile="NInstantMouseEventsUC.ascx.vb" %>
...
<tr>
	<td id="exampleImageCell" class="ImageCell" style="width: 442px; vertical-align: top;">
		...
		<ncwc:NChartControl id="nChartControl1" runat="server" Width="416px" Height="320px" AjaxEnabled="True" AsyncAutoRefreshEnabled="False" AsyncClickEventEnabled="False" AsyncCallbackTimeout="10000" AsyncRequestWaitCursorEnabled="False" AsyncMouseMoveEventEnabled="True" OnQueryAjaxTools="nChartControl1_QueryAjaxTools">
		</ncwc:NChartControl>
