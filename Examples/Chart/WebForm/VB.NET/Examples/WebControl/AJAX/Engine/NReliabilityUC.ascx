<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NReliabilityUC" CodeFile="NReliabilityUC.ascx.vb" %>
...
<tr>
	<td id="exampleImageCell" class="ImageCell" style="width: 442px; vertical-align: middle;">
		...
		<ncwc:NChartControl id="nChartControl1" runat="server" Width="416px" Height="320px" AjaxEnabled="True" AsyncAutoRefreshEnabled="True" AsyncCallbackTimeout="1000" AsyncRefreshInterval="1000" AsyncRequestWaitCursorEnabled="False" AsyncMouseMoveEventEnabled="True" AsyncRefreshEnabled="True" OnAsyncCustomCommand="nChartControl1_AsyncCustomCommand" OnAsyncMouseMove="nChartControl1_AsyncMouseMove" OnAsyncRefresh="nChartControl1_AsyncRefresh" AsyncImageLoadTimeout="1000" OnQueryAjaxTools="nChartControl1_QueryAjaxTools" AjaxScriptBuild="Auto">
		</ncwc:NChartControl>
	...
	<td id="exampleConfigurationCell" class="ControlsPanel" style="width: 300px;">
		...
		enable mouse move and wait 1 minute, before moving the mouse over the chart image.
		</div><br />
