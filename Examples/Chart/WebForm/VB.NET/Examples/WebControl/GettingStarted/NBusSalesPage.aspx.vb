...
Namespace Nevron.Examples.Chart.WebForm
	Public Partial Class NBusSalesPage
		Inherits Page
		Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
			...
			Dim title As NLabel = New NLabel("Bus Sales by Company")
			...
			' setup the watermark
			watermark.FillStyle = New NImageFillStyle(Me.MapPathSecure("~\Images\bus.png"))
