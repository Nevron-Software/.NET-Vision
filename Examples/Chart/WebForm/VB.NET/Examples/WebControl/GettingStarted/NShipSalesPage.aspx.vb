...
Namespace Nevron.Examples.Chart.WebForm
	Public Partial Class NShipSalesPage
		Inherits Page
		Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
			...
			Dim title As NLabel = New NLabel("Ship Sales by Company")
			...
			' setup the watermark
			watermark.FillStyle = New NImageFillStyle(Me.MapPathSecure("~\Images\ship.png"))
			...
			pie.Labels.Add("Austal")
			pie.Labels.Add("Norfolk naval")

			' apply style sheet
			Dim styleSheet As NStyleSheet = NStyleSheet.CreatePredefinedStyleSheet(PredefinedStyleSheet.CoolMultiColor)
