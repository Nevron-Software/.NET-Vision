...
Namespace Nevron.Examples.Chart.WebForm
	Public Partial Class NRangeTimelineScaleUC
		Inherits NExampleUC
		...
		Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
			...
			' set a chart title
			Dim header As NLabel = New NLabel("Range Timeline Scale")
			...
			Dim timelineScale As NRangeTimelineScaleConfigurator = New NRangeTimelineScaleConfigurator()
