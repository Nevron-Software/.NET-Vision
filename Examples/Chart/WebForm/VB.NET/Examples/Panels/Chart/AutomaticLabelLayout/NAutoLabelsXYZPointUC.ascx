...
<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NAutoLabelsXYZPointUC" CodeFile="NAutoLabelsXYZPointUC.ascx.vb" %>
...
<tr>
	<td id="Td2" style="width: 420px;" class="Description">
		...
		<p>
		The example demonstrates the automatic data label layout for a 3D XYZ Scatter Point chart.
		</p>
		<p>
