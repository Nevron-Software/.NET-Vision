...
<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NAutoLabelsRadarUC" CodeFile="NAutoLabelsRadarUC.ascx.vb" %>
...
<tr>
	...
	<td id="exampleConfigurationCell" class="ControlsPanel" rowspan="2" style="width: 325px;">
		...
		<br />
		<br />
		<asp:checkbox id="StackRadarAreasCheckBox" runat="server" AutoPostBack="True" Text="Stack Radar Areas"></asp:checkbox>
		<br />
...
<tr>
	<td id="Td2" style="width: 420px;" class="Description">
		...
		<p>
		Automatic data label layout is supported by Radar charts.
		</p>
		<p>
		...
		<p>
		The "Stack Radar Areas" check box lets you switch between regular and stacked radar area mode.
		</p>
