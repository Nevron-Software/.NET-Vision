...
<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NAutoLabelsXYPointUC" CodeFile="NAutoLabelsXYPointUC.ascx.vb" %>
...
<tr>
	<td id="Td2" style="width: 420px;" class="Description">
		...
		<p>
		The example demonstrates the automatic data label layout for a XY Scatter Point chart.
		</p>
		<p>
