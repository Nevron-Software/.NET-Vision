...
<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NAutoLabelsStackLineUC" CodeFile="NAutoLabelsStackLineUC.ascx.vb" %>
...
<tr>
	<td id="Td2" style="width: 420px;" class="Description">
		...
		<p>
		The example demonstrates automatic data label layout for a stack line chart with two series.
		</p>
		<p>
