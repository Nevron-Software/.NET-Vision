...
<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NAutoLabelsLineUC" CodeFile="NAutoLabelsLineUC.ascx.vb" %>
...
<tr>
	<td id="Td2" style="width: 420px;" class="Description">
		...
		<p>
		The example demonstrates automatic data label layout for a line chart with a single series.
		</p>
		<p>
