...
<%@ Control Language="vb" AutoEventWireup="true" CodeFile="NPolarPointUC.ascx.vb" Inherits="Nevron.Examples.Chart.WebForm.NPolarPointUC" %>
...
The example demonstrates the Polar Point series.<br />
