...
<%@ Control Language="vb" AutoEventWireup="true" CodeFile="NPolarAreaUC.ascx.vb" Inherits="Nevron.Examples.Chart.WebForm.NPolarAreaUC" %>
...
The example demonstrates the Polar Area series.<br />
