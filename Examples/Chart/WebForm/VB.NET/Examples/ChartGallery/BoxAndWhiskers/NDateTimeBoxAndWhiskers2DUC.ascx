<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NDateTimeBoxAndWhiskers2DUC" CodeFile="NDateTimeBoxAndWhiskers2DUC.ascx.vb" %>
...
<tr>
	<td id="Td2" style="width: 420px;" class="Description">
		...
		data. Each box and whisker item represents a set of values and displays 
		...
		This example demonstrates a box and whiskers series with custom date time 
		values. This chart lets you compare the statistical parameters of several data 
		sets that are produced in different moments in time.<br />
		You can use the controls to modify some properties of the box and whiskers 
		series like box size and whiskers size.
