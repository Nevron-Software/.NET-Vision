...
<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NMeshEmptyPointsUC" CodeFile="NMeshEmptyPointsUC.ascx.vb" %>
...
<tr>
	<td id="Td2" style="width: 420px;" class="Description">
		...
		Demonstrates the support for the 'Empty Data Points' feature in mesh surface charts.
		<br />
