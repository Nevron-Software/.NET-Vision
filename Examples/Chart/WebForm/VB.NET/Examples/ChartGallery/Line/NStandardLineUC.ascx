<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NStandardLineUC" CodeFile="NStandardLineUC.ascx.vb" %>
...
<tr>
	...
	<td id="exampleConfigurationCell" class="ControlsPanel" rowspan="2" style="width: 325px;">
		...
		<br />
		<br />
		<asp:Label id="Label3" runat="server">Line Depth %:</asp:Label>
		<br />
