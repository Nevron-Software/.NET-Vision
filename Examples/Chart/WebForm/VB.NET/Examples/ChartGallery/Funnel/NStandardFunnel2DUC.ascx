<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NStandardFunnel2DUC" CodeFile="NStandardFunnel2DUC.ascx.vb" %>
...
<tr>
	<td id="Td2" style="width: 420px;" class="Description">
		...
		This example demonstrates a standard 2D Funnel Chart. Use the controls to 
		modify different parameters of the funnel like radius, neck width, neckheight 
