<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NAdvancedFunnel2DUC" CodeFile="NAdvancedFunnel2DUC.ascx.vb" %>
...
<tr>
	<td id="Td2" style="width: 420px;" class="Description">
		...
		This example demonstrates a 2D Funnel Chart with custom X sizes of the funnel 
