...
Namespace Nevron.Examples.Chart.WebForm
	Public Partial Class NAdvancedFunnel3DUC
		Inherits NExampleUC
		...
		Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
			...
			chart.Size = New NSizeL(New NLength(80, NRelativeUnit.ParentPercentage), New NLength(63, NRelativeUnit.ParentPercentage))
			...
			If (Not IsPostBack) Then
				...
				WebExamplesUtilities.FillComboWithValues(FunnelPointGapDropDownList, 0, 10, 1)
				...
				WebExamplesUtilities.FillComboWithValues(FunnelArrowLengthDropDownList, 0, 20, 1)
				FunnelArrowLengthDropDownList.SelectedIndex = CInt(Fix(funnel.DataLabelStyle.ArrowLength.Value))
			End If
