...
<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NStandardBar2DUC" CodeFile="NStandardBar2DUC.ascx.vb" %>
...
<tr>
	...
	<td id="exampleConfigurationCell" class="ControlsPanel" rowspan="2" style="width: 325px;">
		...
		<br />
		<asp:DropDownList id="ShapeCombo" Height="22" Width="179" runat="server" AutoPostBack="True"></asp:DropDownList>
		<br />
		<br />
		<asp:CheckBox id="ShowDataLabelsCheck" Width="132px" runat="server" AutoPostBack="True" Text="Show data labels"></asp:CheckBox>
		<br />
		<br />
		<asp:CheckBox id="DifferentColorsCheckBox" runat="server" AutoPostBack="True" Text="Different colors"></asp:CheckBox>&nbsp;<br />
		<br />
		<asp:CheckBox id="UseOriginCheck" runat="server" AutoPostBack="True" Text="Use Origin"></asp:CheckBox>
		<br />
		<asp:TextBox id="OriginTextBox" Width="106px" runat="server" AutoPostBack="True"></asp:TextBox>
...
<tr>
	<td id="Td2" style="width: 420px;" class="Description">
		...
		If you check the Different color check all bars will be displayed in 
		different colors<br />
