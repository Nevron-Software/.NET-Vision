...
<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NXYSmoothAreaUC" CodeFile="NXYSmoothAreaUC.ascx.vb" %>
...
<tr>
	...
	<td id="exampleConfigurationCell" class="ControlsPanel" rowspan="2" style="width: 325px;">
		...
		<asp:Button id="btnChangeValues" runat="server" Text="Change Values">
		</asp:Button>
		<br />
		<br />
		...
		<asp:TextBox id="OriginValueTextBox" Width="48px" runat="server" AutoPostBack="True">
		</asp:TextBox>
		<br />
		<br />
...
<tr>
	<td id="Td2" style="width: 420px;" class="Description">
		...
		This example demonstrates a 3D Smooth Area chart with custom values along the X axis.
