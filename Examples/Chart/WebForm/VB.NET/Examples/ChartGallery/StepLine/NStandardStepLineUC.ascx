...
<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NStandardStepLineUC" CodeFile="NStandardStepLineUC.ascx.vb" %>
...
<tr>
	...
	<td id="exampleConfigurationCell" class="ControlsPanel" rowspan="2" style="width: 325px;">
		...
		<asp:Label id="Label4" runat="server">Line Style:</asp:Label>
		<br />
		...
		<br />
		<br />
		<asp:CheckBox id="RoundToTickCheck" runat="server" AutoPostBack="True" Text="Left Axis Round to Tick "></asp:CheckBox>
