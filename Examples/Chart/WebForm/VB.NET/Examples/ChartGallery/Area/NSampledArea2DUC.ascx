...
<%@ Control Language="vb" Inherits="Nevron.Examples.Chart.WebForm.NSampledArea2DUC" CodeFile="NSampledArea2DUC.ascx.vb" %>
...
This example demonstrates how to enable sampling for the area series.<br /><br />
When using sampling the area will ignore settings for markers and data labels and will also automatically resample the data storage depending on the 
