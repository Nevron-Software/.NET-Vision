...
namespace Nevron.Examples.Chart.Wpf
{
	...
	/// 
	/// </summary>
	public partial class NMeshSurfaceCustomColorsUC : NExampleBaseUC
	{
		...
		public override string Title
		{
			get
			{
				return "Mesh Surface Custom Colors";
			}
		}
		...
		public override string Description
		{
			get
			{
				return "The example demonstrates the ability of the Mesh Surface Series to assign custom color per each individual surface vertex.";
			}
		}
