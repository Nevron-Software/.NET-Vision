...
namespace Nevron.Examples.Chart.Wpf
{
	...
	/// 
	/// </summary>
	public partial class NMultiMeasureRadarUC : NExampleBaseUC
	{
		...
		public override string Description
		{
			get
			{
                return "The example demonstrates how to create a multi measure Radar Chart.";
			}
		}
