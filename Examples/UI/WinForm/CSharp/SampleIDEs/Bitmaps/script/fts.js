...
{
    // init table html
    var strTable = "<hr style=\"height: 1px; border: 0; padding: 0; margin: 0 0 3px 0;\"><p class=\"searchtitle\">Search Results</p>";
    ...
    // add footer
    strTable += "</table><p>" + nTotal + " result(s) found.</p>";
...
function showSearchResult(hRef)
{
    ...
    if(!highlight.checked)
    {
        ...
        loadAndExecute(hRef,'highlightContentFrame()');
}
